      ...
      <div className="cadastro-container">
        <div className="cadastro-card">
          <div className="cadastro-info">
            ...
            <p>
              Cadastre-se para aproveitar todos os benefícios do RU da sua
              faculdade.
            </p>
            ...
            <div className="beneficio">
              ...
              <div>
                <h3>Faça pedidos</h3>
                <p>Peça seus pratos favoritos de forma rápida e prática.</p>
              </div>
            </div>
            ...
            <div className="beneficio">
              ...
              <div>
                ...
                <p>Receba promoções e novidades especialmente para você.</p>
              </div>
            </div>
          </div>
          ...
          <div className="cadastro-formulario">
            ...
            <div className="seguranca-box">
              ...
              <div>
                ...
                <p>
                  Sua senha deve ter pelo menos 8 caracteres, incluindo letras,
                  números e símbolos.
                </p>
              </div>
            </div>

            <button className="btn-cadastrar" onClick={cadastrarUsuario}>
              Criar conta
            </button>
